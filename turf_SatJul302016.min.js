...
var destination=require("turf-destination"),helpers=require("turf-helpers"),polygon=helpers.polygon;module.exports=function(e,r,o,n){o=o||64;for(var t=[],i=0;i<o;i++)t.push(destination(e,r,360*i/o,n).geometry.coordinates);return t.push(t[0]),polygon([t])};

},{"turf-destination":2,"turf-helpers":4}],2:[function(require,module,exports){
...
},{"turf-helpers":4,"turf-invariant":3}],3:[function(require,module,exports){
...
},{"turf-helpers":4,"turf-inside":5}],8:[function(require,module,exports){
module.exports={circle:require("turf-circle"),within:require("turf-within")};
},{"turf-circle":1,"turf-within":7}]},{},[8])(8)
});